...
public class RightL extends Shape{
	...
	private static int LocalShapeColor = 3;
	protected final Engine.ShapeType type = Engine.ShapeType.L; 
	private enum RotatePositions {
		UP, DOWN, LEFT, RIGHT
	}
	public RightL(Space[][] gameBoard) {
		super(gameBoard);
		Space shapeSpaces[] = new Space[] {gameBoard[2 + this.verticalOffset][startColumnRightMost],gameBoard[2 + this.verticalOffset][this.startColumnLeftMost],gameBoard[1 + this.verticalOffset][this.startColumnLeftMost],gameBoard[0 + this.verticalOffset][this.startColumnLeftMost]};
	...
	protected boolean canRotate() {	
		try {
			...
			case UP : {
				...
				if (this.gameBoard[coordsOfSpace_0[0]][coordsOfSpace_0[1]-2].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]][coordsOfSpace_2[1]-1].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]][coordsOfSpace_2[1]+1].getColor() == 0) {
					return true;
				}
				else return false;
			}
