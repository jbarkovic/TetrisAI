...
public class LeftL /*J*/ extends Shape{
	...
	protected final Engine.ShapeType type = Engine.ShapeType.J; 
	private enum RotatePositions {
		UP, DOWN, LEFT, RIGHT
	}
	public LeftL(Space[][] gameBoard) {		
		super(gameBoard);
		Space shapeSpaces[] = new Space[] {gameBoard[2 + this.verticalOffset][this.startColumnLeftMost],gameBoard[2 + this.verticalOffset][startColumnRightMost],gameBoard[1 + this.verticalOffset][startColumnRightMost],gameBoard[0 + this.verticalOffset][startColumnRightMost]};
	...
	public boolean rotateForward() {
		...
		case UP : {
			...
			coordsOfNew_0_Space = new int[] {coordsOfOld_0_Space[0]-2,coordsOfOld_0_Space[1]};
		...
		case RIGHT : {
			this.drawSpaces(false);
			coordsOfNew_0_Space = new int[] {coordsOfOld_0_Space[0],coordsOfOld_0_Space[1]+2};
			coordsOfNew_1_Space = new int[] {coordsOfOld_1_Space[0]-1,coordsOfOld_1_Space[1]+1};
			coordsOfNew_2_Space = coordsOfOld_2_Space;
			coordsOfNew_3_Space = new int[] {coordsOfOld_3_Space[0]+1,coordsOfOld_3_Space[1]-1};
	...
	protected boolean canRotate() {	
		try {
			...
			case UP : {
				...
				if (this.gameBoard[coordsOfSpace_0[0]-1][coordsOfSpace_0[1]].getColor() == 0 && this.gameBoard[coordsOfSpace_0[0]-2][coordsOfSpace_0[1]].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]][coordsOfSpace_2[1]+1].getColor() == 0) {
					return true;
				}
				else return false;
			}
			case RIGHT : {
				...
				int[] coordsOfSpace_2 = this.getCoordsOfSpace(this.spaces[2]);
				if (this.gameBoard[coordsOfSpace_2[0]-1][coordsOfSpace_2[1]].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]+1][coordsOfSpace_2[1]].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]-1][coordsOfSpace_2[1]+1].getColor() == 0) {
					return true;
				}
				else {
					return false;
			...
			case LEFT : {
				...
				int[] coordsOfSpace_2 = this.getCoordsOfSpace(this.spaces[2]);
				int[] coordsOfSpace_3 = this.getCoordsOfSpace(this.spaces[3]);
				if (this.gameBoard[coordsOfSpace_3[0]+1][coordsOfSpace_3[1]].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]+1][coordsOfSpace_2[1]].getColor() == 0 && this.gameBoard[coordsOfSpace_2[0]-1][coordsOfSpace_2[1]].getColor() == 0) {
					return true;
				}
			}
			}
